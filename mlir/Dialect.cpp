//===----------------------------------------------------------------------===//
//
// This file implements the dialect for the Ive IR: custom type parsing and
...
#include "ive/Dialect.cpp.inc"

//===----------------------------------------------------------------------===//
// IveInlinerInterface
//===----------------------------------------------------------------------===//

/// This class defines the interface for handling inlining with Ive
/// operations.
struct IveInlinerInterface : public DialectInlinerInterface {
  ...
  /// All call operations within ive can be inlined.
  bool isLegalToInline(Operation *call, Operation *callable,
                       bool wouldBeCloned) const final {
    return true;
  }

  /// All operations within ive can be inlined.
  bool isLegalToInline(Operation *, Region *, bool, IRMapping &) const final {
    return true;
  }

  // All functions within ive can be inlined.
  ...
  /// Handle the given inlined terminator(ive.return) by replacing it with a new
  /// operation as necessary.
  void handleTerminator(Operation *op, ValueRange valuesToRepl) const final {
    // Only "ive.return" needs to be handled here.
...
namespace ive {
namespace detail {
/// This class represents the internal storage of the Ive `StructType`.
...
/// Parse an instance of a type registered to the ive dialect.
mlir::Type IveDialect::parseType(mlir::DialectAsmParser &parser) const {
...
/// Print an instance of a type registered to the ive dialect.
void IveDialect::printType(mlir::Type type,
                           mlir::DialectAsmPrinter &printer) const {
  // Currently the only ive type is a struct type.
...
void IveDialect::initialize() {
  addInterfaces<IveInlinerInterface>();
  addTypes<StructType>();
...
mlir::Operation *IveDialect::materializeConstant(mlir::OpBuilder &builder,
