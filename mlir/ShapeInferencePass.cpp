...
#include "ive/ShapeInferenceOpInterfaces.cpp.inc"
...
struct ShapeInferencePass
    : public mlir::PassWrapper<ShapeInferencePass, OperationPass<ive::FuncOp>> {
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(ShapeInferencePass)
  StringRef getArgument() const override { return "ive-shape-inference"; }
...
std::unique_ptr<mlir::Pass> mlir::ive::createShapeInferencePass() {
